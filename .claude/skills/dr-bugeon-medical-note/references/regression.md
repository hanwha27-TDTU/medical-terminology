...
node scripts/check-restore-drift.mjs   # 복원 드리프트: <domain>ToRow 컬럼 ↔ rowTo<Domain> 읽기(복원/새 기기 유실 급소)
...
## 한 줄
**머지 전 (A) 자동검사 전부 통과는 AI의 의무, (B) 실기기 확인은 사용자 몫 — 둘을 섞어 "테스트했다"고 뭉뚱그리지 말 것.**
